...
public class GrpcApplication {
    ...
    public static void main(String[] args) {
        ...
        setUserResult = stub.setUser(User.newBuilder()
                .setUsername("KIM MINSU")
                .setEmail("minsu@test.com")
                .addRoles("USER")
                .build());
        System.out.println("Client: " + setUserResult.getIdx(0));
        ...
        StreamObserver<UserIdx> responesObserver = new StreamObserver<UserIdx>() {
            @Override
        ...
        StreamObserver<User> requestObserver = asyncStub.setUsers(responesObserver);
